...
const HIGH_SPEND_PER_PERSON_RULE = {
...
const OVERLAPPING_CODING_ASSISTANTS_RULE = {
    ...
    evaluate: (data)=>{
        ...
        const userCodingTools = data.tools.filter((t)=>codingTools.some((ct)=>t.tool.toLowerCase().includes(ct.toLowerCase())));
...
const SMALL_TEAM_ENTERPRISE_SEATS_RULE = {
...
function AuditForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveAuditReport"])(report);
            // Try to save to MongoDB (non-blocking)
            try {
                const { saveAuditReportToDatabase } = await __turbopack_context__.A("[project]/lib/mongodb.ts [app-ssr] (ecmascript, async loader)");
...
//# sourceMappingURL=_0hwqx22._.js.map